...
import { Navbar, InputBox, MsgBox, InfoBar } from "./components";
const Main = () => {
    ...
    return (
        <main className="h-screen overflow-y-hidden flex">
            ...
            <aside id="sidebar" className="h-screen sidebar overflow-y-scroll custom-scroll-bar sidebar-hide"></aside>
